        ...
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ eurl("/courses/".$subscriber_id) }}">{{ trans('admin.courses') }}</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                <form class="form form-horizontal striped-rows form-bordered" method="post" enctype="multipart/form-data"  action="{{ eurl('/courses/update/'.$subscriber_id.'/'.$id) }}">
                                    @csrf
                                    <div class="form-body">
                                        <!-- Name -->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    ...
                                                    name="days_no" value="{{ $edit->days_no }}">
                                                    <div class="form-control-position">
                                                        <i class="la la-calender"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    ...
                                                    name="hours_no" value="{{ $edit->hours_no }}">
                                                    <div class="form-control-position">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="position-relative has-icon-left">
                                                    <textarea class="form-control" rows="4"  name="object" >{{ $edit->object }}</textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group col-md-9 contact-repeater">
                                                <div data-repeater-list="repeater">
                                                    @foreach ($edit->level as $level)
                                                        <div class="input-group mb-1" data-repeater-item>
                                                            <input type="text" name="level_name" placeholder="{{ trans('admin.level_name') }}" class="form-control" id="example-tel-input" value="{{ $level->title }}">
                                                            <input type="hidden" name="level_id" value="{{$level->id}}"   class="form-control" >
                                                            <input type="number"  class="form-control" placeholder="{{ trans('admin.level_number') }}"
                                                            name="level_number" value="{{ $level->ordering }}">
                                        ...
                                        @if ($edit->logo)
                                           <div class="form-group row">
                                               ...
                                               <div class="col-md-9">
                                                   <div class="position-relative has-icon-left">
                                                   <img src="{{ asset('uploads/'.$edit->logo) }}" title="{{ trans('admin.photo') }}" style="height:100px; width:200px;" />
                                                   </div>
                                               </div>
                                           </div>
                                       @endif
                                        <div class="form-group row">
                                            <label class="col-md-3 label-control" for="timesheetinput2">{{ trans('admin.edit') }} {{ trans('admin.photo') }}</label>
                                            <div class="col-md-9">
                                                <div class="position-relative has-icon-left">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <select name="category_id" class="form-control">
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->category->id }}" {{ $edit->category_id == $category->category->id ? "selected" : ""   }}>{{ $category->category->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="form-control-position">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    <div class="d-inline-block custom-control custom-radio mr-1" style="margin: auto 20px !important;">
                                                        <input type="radio" name="active" value="1" {{ $edit->status == '1' ? 'checked' : '' }} class="custom-control-input" id="yes" >
                                                        <label class="custom-control-label" for="yes">{{ trans('admin.yes') }}</label>
                                                    </div>
                                                    <div class="d-inline-block custom-control custom-radio">
                                                        <input type="radio" name="active" value="0" {{ $edit->status == '0' ? 'checked' : '' }} class="custom-control-input" id="no" >
