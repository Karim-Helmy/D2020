                ...
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ eurl('/groups/'.$id.'/'.$subscriber_id) }}">{{ trans('admin.group courses') }}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        <form class="form form-horizontal striped-rows form-bordered" method="post"  action="{{ eurl('/groups/store/'.$id.'/'.$subscriber_id) }}">
                                            @csrf
                                            <div class="form-body">
