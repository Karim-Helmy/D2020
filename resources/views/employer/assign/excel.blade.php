                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        <form class="form form-horizontal striped-rows form-bordered" method="post" enctype="multipart/form-data"  action="{{ eurl('/assign/import/'.$id.'/'.$subscriber_id) }}">
                                            @csrf
                                            <div class="form-body">
                                                <a href="{{ asset('uploads/excel2.xlsx') }}" style="border:none;" class="main_title">{{ trans('admin.download example') }}</a>
