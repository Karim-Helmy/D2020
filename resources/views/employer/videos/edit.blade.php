                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        <form class="form form-horizontal striped-rows form-bordered" method="post"  enctype="multipart/form-data"  action="{{ route('employer.video.update', [$edit->id,$subscriber_id]) }}">
                                            @csrf
                                            @method('PATCH')
                                            <div class="form-body">
