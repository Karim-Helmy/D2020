                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        <form class="form form-horizontal striped-rows form-bordered" method="post"   enctype="multipart/form-data"  action="{{ route('employer.exam.update', [$edit->id,$subscriber_id]) }}">
                                            @csrf
                                            @method('PATCH')
                                            <div class="form-body">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="position-relative has-icon-left">
                                                            <select class="form-control"  name="level_id">
                                                                <option value="" {{ $edit->level_id == null ? "selected" : ""   }}>{{ trans('admin.comprehensive') }}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="position-relative has-icon-left">
                                                            ...
                                                            name="time_minutes" value="{{ $edit->time_minutes }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="position-relative has-icon-left">
                                                            ...
                                                            name="success_average" value="{{ $edit->success_average }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="position-relative has-icon-left">
                                                            ...
                                                            name="question_no" value="{{ $edit->question_no }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <div class="d-inline-block custom-control custom-radio mr-1" style="margin: auto 20px !important;">
                                                            <input type="radio" name="question_choose" value="1" {{ $edit->question_choose == '1' ? 'checked' : '' }} class="custom-control-input" id="yes" >
                                                            <label class="custom-control-label" for="yes">{{ trans('admin.yes') }}</label>
                                                        </div>
                                                        <div class="d-inline-block custom-control custom-radio">
                                                            <input type="radio" name="question_choose" value="0" {{ $edit->question_choose == '0' ? 'checked' : '' }} class="custom-control-input" id="no" >
