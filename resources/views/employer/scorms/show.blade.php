...
<html lang=en>
    ...
    */
    ...
    function init(){
    	var location_c = 'besteam';
    	var username = 'Wael Serag';
        model.cmi.core.student_id.dv=""+iv.studentId;
        model.cmi.core.student_name.dv=username.value;
        ...
        model.cmi.core.exit.dv='suspend';
        model.cmi.suspend_data.dv= location_c.value;
    ...
    <div id="logDisplay">
        <iframe src="{{ asset('uploads/'.$scorm.'/'.$link) }}"  frameborder="0" style="overflow:hidden;height:100vh;width:100%"   sandbox="allow-forms allow-pointer-lock allow-same-origin allow-scripts allow-top-navigation" />
    </div>
</body>
</html>
