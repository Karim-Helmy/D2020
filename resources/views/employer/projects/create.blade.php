                ...
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ eurl('/projects/levels/'.$id.'/'.$subscriber_id) }}">{{ trans('admin.projects') }}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        <form class="form form-horizontal striped-rows form-bordered" method="post"   enctype="multipart/form-data"  action="{{ eurl('/projects/store/'.$id.'/'.$subscriber_id) }}">
                                            @csrf
                                            <div class="form-body">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <div class="d-inline-block custom-control custom-radio mr-1" style="margin: auto 20px !important;">
                                                            <input type="radio" name="file_upload" value="1" {{ old('file_upload') == '1' ? 'checked' : '' }} class="custom-control-input" id="yes" >
                                                            <label class="custom-control-label" for="yes">{{ trans('admin.yes') }}</label>
                                                        </div>
                                                        <div class="d-inline-block custom-control custom-radio">
                                                            <input type="radio" name="file_upload" value="0" {{ old('file_upload') == '0' ? 'checked' : '' }} class="custom-control-input" id="no" >
