      ...
      <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        ...
        <div class="row breadcrumbs-top d-inline-block">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ aurl("/packages/create") }}">{{ trans('admin.add package') }}</a>
              </li>
            </ol>
          </div>
        </div>
                    ...
                    <tbody>
                        @foreach ($index as $i)
                            <tr id="show_{{ $i->id }}">
                                ...
                                <td>{{ $i->price }}</td>
                                <td>
                                    <a href="{{ aurl('/packages/show/'.$i->id) }}" class="btn btn-info btn-min-width mr-1 mb-1"><i
                                            class="far fa-eye"></i> {{ trans('admin.show') }}</a>
                                            &nbsp;&nbsp;&nbsp;
                                    <a href="{{ aurl('/packages/edit/'.$i->id) }}" class="btn btn-secondary btn-min-width mr-1 mb-1"><i
