                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                <form class="form form-horizontal striped-rows form-bordered" method="post" enctype="multipart/form-data"  action="{{ route('scorms.update', [$edit->id]) }}">
                                    @csrf
                                    @method('PATCH')
                                    <div class="form-body">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <select name="category_id[]" multiple class="form-control">
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}" {{ in_array($category->id, $edit->getCategoryId() ?? []) ? "selected" : ""   }}>{{ $category->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="form-control-position">
