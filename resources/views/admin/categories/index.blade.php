      ...
      <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        ...
        <div class="row breadcrumbs-top d-inline-block">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ aurl("/categories/create") }}">{{ trans('admin.add category') }}</a>
              </li>
            </ol>
          </div>
        </div>
                    ...
                    <tbody>
                        @foreach ($index as $i)
                            <tr id="show_{{ $i->id }}">
                                <td>{{ $i->name }}</td>
                                <td>
                                    <img class="gallery-thumbnail card-img-top" src="{{ asset('uploads/'.$i->image) }}" itemprop="thumbnail" alt="Image description" style="width:100px !important;" >
                                </td>
                                <td>{{ $i->created_at }}</td>
                                <td>
                                    <a href="{{ aurl('/categories/edit/'.$i->id) }}" class="btn btn-secondary btn-min-width mr-1 mb-1"><i
